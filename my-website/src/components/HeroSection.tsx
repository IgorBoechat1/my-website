...
const HeroSection = () => {
  return (
    <section className="min-h-150vh  flex items-center justify-center p-1">
      <section
        id="hero"
        className="relative min-h-150vh  flex flex-col items-center justify-center bg-fixed bg-center bg-cover"
      ...
      >
        ...
        {/* Text Content */}
        <div className="relative z-20 flex flex-col min-h-full items-center justify-center text-[#ededed] mt-40 mb-40 sm:px-8 md:px-16 lg:px-32 xl:px-40" style={{ lineHeight: '0.8' }}>
